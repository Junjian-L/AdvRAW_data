...
learning_rate = 0.00005 # original learning rate 0.001
...
def train_model():
    ...
    generator.load_state_dict(torch.load("original_models/generator_epoch_31.pth"), strict=True)
    ...
    for epoch in range(num_train_epochs):
        ...
        for i in range(len(train_loader)):
            ...
            total_loss = loss_mse + (1-loss_ssim) * 0.1
